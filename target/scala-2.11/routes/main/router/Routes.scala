...
class Routes extends GeneratedRouter {
  ...
  def documentation: Seq[(String, String, String)] = List(
    ...
    ("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """transfer""", """controllers.Application.transferMoney()"""),
  ...
  // @LINE:7
  private[this] lazy val controllers_Application_transferMoney1_route: Route.ParamsExtractor = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("transfer")))
  )
  private[this] lazy val controllers_Application_transferMoney1_invoker = createInvoker(
    controllers.Application.transferMoney(),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "transferMoney",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_Application_transferMoney1_route(params) =>
      call { 
        controllers_Application_transferMoney1_invoker.call(controllers.Application.transferMoney())
      }
